🖐️ ¡Hola, soy Estoico (o "El Cojo" para los colegas)!
👨‍💻 ¿Quién soy?
...
Si tiene chips, cables o LEDs, yo me encargo.
...
Soy alguien que aprende rápido y que no le tiene miedo a un pantallazo azul ni a un error 500. Mi objetivo ahora es mejorar como programador y fusionar ese mundo con mi pasión por el hardware.
